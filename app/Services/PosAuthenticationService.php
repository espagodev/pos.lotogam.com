...
class PosAuthenticationService
{
    ...
    use ConsumesExternalServices, InteractsWithPosResponses;
    ...
    public function __construct()
    {
        ...
        $this->passwordClientId = config('services.pos.password_client_id');
        $this->passwordClientSecret = config('services.pos.password_client_secret');
    }
