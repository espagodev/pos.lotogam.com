                    ...
                    if (($horariocierre == 0) && ($horarioApertura == 1)){
                                ...
                                $output .='<div class="col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4"> 
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="' . $detalle->lot_nombre . '" data-loterias_id="' . $detalle->loterias_id . '"  data-superpale="0"><span class="badge badge-success m-1 validar-monto"><h6 class="text-white">' . $detalle->lot_nombre .'</h6></span></label>
                                    </div>
                                </div>';
                    } else {
                        $output .='<div class="col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4"> 
                    ...
                    if ($horariocierre == 0) {
                                ...
                                $output .='<div class="col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4"> 
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="' . $detalle->lot_nombre . '" data-loterias_id="' . $detalle->loterias_id . '"  data-superpale="' . $detalle->lot_superpale . '"><span class="badge badge-info m-1 "><h6 class="text-white">' . $detalle->lot_nombre .'</h6></span></label>
                                    </div>
                                </div>';
                    } else {
                        $output .='<div class="col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4"> 
